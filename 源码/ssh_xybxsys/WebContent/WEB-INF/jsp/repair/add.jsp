...
<div class="panel admin-panel margin-top">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="${ctx}/repair_exAdd.do" enctype="multipart/form-data">   
      <div class="form-group">
        <div class="label">
          <label>设备名：</label>
        </div>
        <div class="field">
          <input type="text" class="input w50" name="sbm" value="" data-validate="required:请输入设备名称" />         
          <div class="tips"></div>
        </div>
      </div> 
        <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="dd" value="" data-validate="required:请输入地点" />         
          <div class="tips"></div>
        </div>
      </div> 
       <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <textarea class="input" name="yy" style=" height:90px;"></textarea>
          <div class="tips"></div>
        </div>
      </div>
    <!--   后勤部；教务处；校长办公室；宿管部 -->
