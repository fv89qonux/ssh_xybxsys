...
<div class="submain">
  ...
  <div class="subtitle">
    <div class="subtitle_body">
      <div class="subt_left"><span>用户信息</span></div>
      <div class="subt_right"> 首页 > 用户信息 </div>
    </div>
  </div>
  <div class="subten">
  ...
  <div class="subbody">
      ...
      <div class="sideblock">
        <div class="blockone">
         ...
         <div class="blockthr">
                <ul>
                <li>
                	<div class="timg"><img src="${ctx}/resource/images/ban002.png" /></div>
          <div class="ttxt"> <a href="${ctx}/user_view2.do">
            <h1>修改密码</h1>
    ...
    <div class="subcontent">
      <div class="smtit"><span class="smtle">个人信息</span></div>
      <div class="article">
    ...
    <form method="post" class="form-x" action="${ctx}/user_exUpdate3.do" enctype="multipart/form-data">   
     <input type="hidden" name="id" value="${User.id}"> 
      <div class="form-group" >
        ...
        <div class="field">
          <input type="text" class="input w50" name="userName" value="${User.userName}" data-validate="required:请输入登录名" disabled="disabled"/>         
          <div class="tips"></div>
        </div>
      </div> 
        <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="phone" value="${User.phone}" data-validate="required:请输入手机号" disabled="disabled" />         
          <div class="tips"></div>
        </div>
      </div> 
       ...
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="realName" value="${User.realName}" data-validate="required:请输入真实名" disabled="disabled"/>         
          <div class="tips"></div>
        </div>
      </div> 
